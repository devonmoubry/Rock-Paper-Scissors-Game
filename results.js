function displayMatchWinner(winner) {
  ...
  if (winner === 'tie') {
    ...
    $g_matchResultsWindow.html('Player1 wins! You da bomb!');
  } else if (winner === 'player2') {
    console.log('Player 2 wins! All you do is win! win! win!');
    $g_matchResultsWindow.html('Player 2 wins! All you do is win! win! win!');
  } else {
    console.log('Why can’t you be a team player? Try playing again.');
    $g_matchResultsWindow.html('Why can’t you be a team player? Try playing again.');
  }
  console.log('\n 🔄 Play another match?? \n ');
  $g_matchResultsWindow.append(' 🔄 Play another match??');
